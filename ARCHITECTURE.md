...
stat, fstat, fstatat, statx (kind, mode, link count, owner, the four timestamps, an honest statx mask; `/dev/urandom` is its devtmpfs node, a root-owned `0666` character device 1:9)
