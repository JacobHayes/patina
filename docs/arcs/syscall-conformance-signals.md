...
- Recorded traces (format ≥ 9; `signal_generated` ops, in order): `signal/basic` [10:p 10:t 10:t]; `signal/raw_action` [10:p 10:p]; `signal/queue` [34:p 34:p 34:t 10:p 10:p 35:p 34:p 34:p 12:p 10:p 34:p 34:t]; `signal/unmask` [10:p 10:t 12:p 10:p]; `signal/altstack` [10:p]; `signal/per_thread` [10:p 10:t].
