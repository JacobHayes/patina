//! The syscall registry's object-level and classification gates (design §3
//! tests (d) and (e)):
//!
...
//!   defines.
//!
//! The comparisons are pure functions over symbol sets, and
//! `planted_gaps_are_reported` feeds them a doctored set so the gate cannot
//! silently pass.
