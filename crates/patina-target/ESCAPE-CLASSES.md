...
- **Process-spawn family** (`fork`, `posix_spawn*`, `execvp`, `waitpid`,
  `setsid`/`setgid`/`setuid`/`setpgid`/`setgroups`, `chroot`, and
  `kill`) —
