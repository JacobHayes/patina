...
pub const SCENARIO: Scenario = Scenario {
    ...
    gaps: &[Gap {
        ...
        what: "openat2 is a soft deny: every call answers ENOSYS (and prints the shared diagnostic) where the kernel opens, creates and refuses per struct open_how (size EINVAL/E2BIG, strict flags and mode EINVAL, RESOLVE_* EXDEV/ELOOP/EAGAIN); the registry row is SoftDeny(ENOSYS) so callers fall back to component-wise openat; the created-file stat after the refused O_CREAT cascades; the registry row names no closes_in yet (the fs arc models it). The inode checks read the opened descriptor unobserved, so an openat2 that starts answering carries the identity check without shifting the stream",
        failure: Failure::Differs(&[
            Difference::field(14, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::field(14, "openat2", "ret", Observed::Int(-1)),
            Difference::check(15, "openat2 opens by path"),
            Difference::field(16, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(17, "a struct smaller than OPEN_HOW_SIZE_VER0 is EINVAL"),
            Difference::field(18, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(19, "a struct larger than a page is E2BIG"),
            Difference::field(20, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::field(20, "openat2", "ret", Observed::Int(-1)),
            Difference::check(21, "a larger struct with zero trailing bytes is accepted"),
            Difference::field(22, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(23, "nonzero trailing bytes are E2BIG"),
            Difference::field(24, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(25, "an upper-32-bit flag is EINVAL"),
            Difference::field(26, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(27, "a mode without O_CREAT is EINVAL"),
            Difference::field(28, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(29, "a mode past 07777 is EINVAL"),
            Difference::field(30, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(31, "an unknown RESOLVE_* bit is EINVAL"),
            Difference::field(32, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(33, "RESOLVE_BENEATH with RESOLVE_IN_ROOT is EINVAL"),
            Difference::field(34, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(35, "RESOLVE_CACHED with O_CREAT is EAGAIN"),
            Difference::field(36, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::field(36, "openat2", "ret", Observed::Int(-1)),
            Difference::check(37, "O_CREAT with a mode creates"),
            Difference::field(38, "newfstatat", "errno", Observed::Str("ENOENT")),
            Difference::field(38, "newfstatat", "fields.gid", Observed::Null),
            Difference::field(38, "newfstatat", "fields.ino", Observed::Null),
            Difference::field(38, "newfstatat", "fields.kind", Observed::Null),
            Difference::field(38, "newfstatat", "fields.nlink", Observed::Null),
            Difference::field(38, "newfstatat", "fields.perm", Observed::Null),
            Difference::field(38, "newfstatat", "fields.size", Observed::Null),
            Difference::field(38, "newfstatat", "fields.uid", Observed::Null),
            Difference::field(38, "newfstatat", "ret", Observed::Int(-1)),
            Difference::check(39, "the created file carries the mode"),
            Difference::field(40, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(41, "O_CREAT|O_EXCL on an existing name is EEXIST"),
            Difference::field(42, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(43, "a missing name is ENOENT"),
            Difference::field(44, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(45, "O_DIRECTORY on a file is ENOTDIR"),
            Difference::field(46, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::field(46, "openat2", "ret", Observed::Int(-1)),
            Difference::check(47, "RESOLVE_BENEATH allows a path beneath the dirfd"),
            Difference::field(48, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::field(48, "openat2", "ret", Observed::Int(-1)),
            Difference::check(49, "RESOLVE_BENEATH follows a symlink that stays beneath"),
            Difference::field(50, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(51, "RESOLVE_BENEATH refuses `..` past the dirfd"),
            Difference::field(52, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(53, "RESOLVE_BENEATH refuses a symlink out of the dirfd"),
            Difference::field(54, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(55, "RESOLVE_BENEATH refuses an absolute path"),
            Difference::field(56, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::field(56, "openat2", "ret", Observed::Int(-1)),
            Difference::check(
                57,
                "RESOLVE_IN_ROOT resolves an absolute path inside the dirfd",
            ),
            Difference::field(58, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::field(58, "openat2", "ret", Observed::Int(-1)),
            Difference::check(59, "RESOLVE_IN_ROOT clamps `..` at the dirfd"),
            Difference::field(60, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(61, "RESOLVE_NO_SYMLINKS refuses a symlink"),
            Difference::field(62, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::field(62, "openat2", "ret", Observed::Int(-1)),
            Difference::check(63, "RESOLVE_NO_SYMLINKS allows a plain path"),
            Difference::field(64, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::field(64, "openat2", "ret", Observed::Int(-1)),
            Difference::check(65, "RESOLVE_NO_MAGICLINKS allows an ordinary symlink"),
            Difference::field(66, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::field(66, "openat2", "ret", Observed::Int(-1)),
            Difference::check(67, "RESOLVE_NO_XDEV allows a path on one mount"),
            Difference::field(68, "openat2", "errno", Observed::Str("ENOSYS")),
            Difference::check(69, "openat2 relative to a closed descriptor is EBADF"),
        ]),
    }],
    ..DEFAULTS
};
