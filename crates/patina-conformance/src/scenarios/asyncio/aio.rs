...
pub const SCENARIO: Scenario = Scenario {
    ...
    gaps: &[Gap {
        ...
        vehicles: Vehicle::KERNEL,
        what: "the Linux AIO rows are SoftDeny(ENOSYS) in the registry: the virtual kernel is built without AIO (CONFIG_AIO=n), which libaio users detect at io_setup and fall back from, so every call answers ENOSYS where the host kernel has AIO",
        failure: Failure::Differs(&[
            Difference::field(0, "io_setup", "errno", Observed::Str("ENOSYS")),
            Difference::check(1, "io_setup of no events is EINVAL"),
            Difference::field(2, "io_setup", "errno", Observed::Str("ENOSYS")),
            Difference::check(
                3,
                "io_setup into a context word that is not zeroed is EINVAL",
            ),
            Difference::field(4, "io_setup", "errno", Observed::Str("ENOSYS")),
            Difference::check(5, "io_setup into NULL is EFAULT"),
            Difference::field(6, "io_destroy", "errno", Observed::Str("ENOSYS")),
            Difference::check(7, "io_destroy of a context never created is EINVAL"),
            Difference::field(8, "io_submit", "errno", Observed::Str("ENOSYS")),
            Difference::check(9, "io_submit to a context never created is EINVAL"),
            Difference::field(10, "io_getevents", "errno", Observed::Str("ENOSYS")),
            Difference::check(11, "io_getevents from a context never created is EINVAL"),
            Difference::field(12, "io_setup", "errno", Observed::Str("ENOSYS")),
            Difference::field(12, "io_setup", "ret", Observed::Int(-1)),
            Difference::check(13, "io_setup of four events creates a context"),
            Difference::check(14, "the context id is non-zero"),
            Difference::field(16, "io_submit", "errno", Observed::Str("ENOSYS")),
            Difference::field(16, "io_submit", "ret", Observed::Int(-1)),
            Difference::check(17, "a buffered write is submitted"),
            Difference::field(18, "io_cancel", "errno", Observed::Str("ENOSYS")),
            Difference::check(
                19,
                "io_cancel of a write that completed at submission is EINVAL",
            ),
            Difference::field(20, "io_getevents", "errno", Observed::Str("ENOSYS")),
            Difference::field(20, "io_getevents", "fields.events", Observed::Json("[]")),
            Difference::field(20, "io_getevents", "ret", Observed::Int(-1)),
            Difference::check(21, "io_getevents reaps the write's one event"),
            Difference::field(22, "io_getevents", "errno", Observed::Str("ENOSYS")),
            Difference::field(22, "io_getevents", "ret", Observed::Int(-1)),
            Difference::check(23, "nothing more is pending: io_getevents answers 0"),
            Difference::field(24, "io_pgetevents", "errno", Observed::Str("ENOSYS")),
            Difference::field(24, "io_pgetevents", "ret", Observed::Int(-1)),
            Difference::check(25, "io_pgetevents with nothing pending answers 0"),
            Difference::field(26, "io_getevents", "errno", Observed::Str("ENOSYS")),
            Difference::check(27, "a minimum above the maximum is EINVAL"),
            Difference::field(28, "io_submit", "errno", Observed::Str("ENOSYS")),
            Difference::field(28, "io_submit", "ret", Observed::Int(-1)),
            Difference::check(29, "a read is submitted"),
            Difference::field(30, "io_pgetevents", "errno", Observed::Str("ENOSYS")),
            Difference::field(30, "io_pgetevents", "fields.events", Observed::Json("[]")),
            Difference::field(30, "io_pgetevents", "ret", Observed::Int(-1)),
            Difference::check(
                31,
                "io_pgetevents reaps the read, which returns what the write wrote",
            ),
            Difference::field(33, "io_submit", "errno", Observed::Str("ENOSYS")),
            Difference::field(33, "io_submit", "ret", Observed::Int(-1)),
            Difference::check(34, "a poll of an empty pipe is submitted"),
            Difference::field(35, "poll_key_after_submit", "fields.key", Observed::Int(7)),
            Difference::check(36, "io_submit stores the kernel's key, 0, in the iocb"),
            Difference::field(37, "io_cancel", "errno", Observed::Str("ENOSYS")),
            Difference::check(
                38,
                "io_cancel of an iocb whose key is not the kernel's is EINVAL",
            ),
            Difference::field(39, "io_cancel", "errno", Observed::Str("ENOSYS")),
            Difference::check(40, "io_cancel of the poll in flight is EINPROGRESS"),
            Difference::field(41, "io_getevents", "errno", Observed::Str("ENOSYS")),
            Difference::field(41, "io_getevents", "fields.events", Observed::Json("[]")),
            Difference::field(41, "io_getevents", "ret", Observed::Int(-1)),
            Difference::check(42, "the cancelled poll completes with result 0"),
            Difference::field(43, "io_cancel", "errno", Observed::Str("ENOSYS")),
            Difference::check(44, "a second io_cancel of it is EINVAL"),
            Difference::field(46, "io_submit", "errno", Observed::Str("ENOSYS")),
            Difference::field(46, "io_submit", "ret", Observed::Int(-1)),
            Difference::check(47, "a poll of a readable pipe is submitted"),
            Difference::field(48, "io_getevents", "errno", Observed::Str("ENOSYS")),
            Difference::field(48, "io_getevents", "fields.events", Observed::Json("[]")),
            Difference::field(48, "io_getevents", "ret", Observed::Int(-1)),
            Difference::check(49, "it completed at submission with POLLIN"),
            Difference::field(52, "io_submit", "errno", Observed::Str("ENOSYS")),
            Difference::check(53, "an unknown opcode is EINVAL"),
            Difference::field(54, "io_submit", "errno", Observed::Str("ENOSYS")),
            Difference::check(55, "a reserved field set is EINVAL"),
            Difference::field(56, "io_submit", "errno", Observed::Str("ENOSYS")),
            Difference::check(57, "a closed descriptor is EBADF"),
            Difference::field(58, "io_submit", "errno", Observed::Str("ENOSYS")),
            Difference::field(58, "io_submit", "ret", Observed::Int(-1)),
            Difference::check(59, "no iocbs submit nothing"),
            Difference::field(60, "io_destroy", "errno", Observed::Str("ENOSYS")),
            Difference::field(60, "io_destroy", "ret", Observed::Int(-1)),
            Difference::check(61, "io_destroy ends the context"),
            Difference::field(62, "io_destroy", "errno", Observed::Str("ENOSYS")),
            Difference::check(63, "a destroyed context is EINVAL"),
        ]),
    }],
    ..DEFAULTS
};
