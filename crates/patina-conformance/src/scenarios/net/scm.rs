...
pub const SCENARIO: Scenario = Scenario {
    ...
    gaps: &[
        Gap {
            ...
            what: "sendmsg is a soft-deny ENOSYS (c/posix/net.c sendmsg, sud/net.rs sys_sendmsg; recvmsg likewise): no ancillary data — SCM_RIGHTS or SCM_CREDENTIALS — crosses a socketpair",
            failure: Failure::Differs(&[
                Difference::field(6, "sendmsg", "errno", Observed::Str("ENOSYS")),
                Difference::field(6, "sendmsg", "ret", Observed::Int(-1)),
            ]),
        },
        Gap {
            status: Status::Pending(Arc::NetworkReadiness),
            vehicles: Vehicle::ALL,
            what: "with sendmsg refused the scenario cannot continue",
            failure: Failure::Stops {
                events: 7,
                ending: Ending::Exit(101),
                diagnostic: "net/scm: cannot continue: sendmsg with SCM_RIGHTS",
            },
        },
    ],
    ..DEFAULTS
