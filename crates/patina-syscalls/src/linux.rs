...
pub const fn disposition(id: Syscall) -> SyscallRow {
    ...
    Syscall::N_inotify_init => r(
        ...
        Family::Readiness,
        Disposition::Modeled,
        "An inotify instance (`thread::inotify`, `FdKind::Inotify`): `inotify_init1(0)`.",
        None,
    ),
    ...
    Syscall::N_inotify_rm_watch => r(
        ...
        Family::Readiness,
        Disposition::Modeled,
        "Ends a watch with `IN_IGNORED` (`thread::inotify`); a descriptor not watched is `EINVAL`.",
        None,
    ),
    ...
    Syscall::N_inotify_init1 => r(
        ...
        Family::Readiness,
        Disposition::Modeled,
        "An inotify instance (`thread::inotify`, `FdKind::Inotify`): read-only, `IN_NONBLOCK`/`IN_CLOEXEC` set the description's flags, another flag `EINVAL`, past 128 instances `EMFILE`; events queued by the filesystem entries (`fsnotify`), merged and overflowed as `fs/notify` does, read whole, `FIONREAD`, readiness through the reactor.",
        None,
    ),
    Syscall::N_preadv => r(
        id,
